...
mneTmp_outFname = fullfile(data_path, 'mnesource_tmp2.mat');
...
mridata_tmp     = fullfile(fs_subject_dir, '0177warp2/mri/T1.mgz');
...
srcFname_tmpL = fullfile(fs_subject_dir,'0177warp2/workbench/0177warp2.L.white.4k_fs_LR.surf.gii');
srcFname_tmpR = fullfile(fs_subject_dir,'0177warp2/workbench/0177warp2.R.white.4k_fs_LR.surf.gii');
...
% % Save 
save(fullfile(data_path, 'mri_tmp_seg2.mat'), 'mri_tmp_seg')
...
% Save headmodels
fprintf('Saving...')
save(fullfile(data_path, 'headmodel_mne_tmp2.mat'), 'headmodel_tmp')
% save(fullfile(data_path, 'headmodel_mne_org.mat'), 'headmodel_org')
% save(fullfile(data_path, 'surfsrc_org'), 'surfsrc_org', '-v7.3');
save(fullfile(data_path, 'surfsrc_tmp2'), 'surfsrc_tmp', '-v7.3');
disp('DONE')
